    ...
    return (
        <Card className={`w-full rounded-2xl shadow-md p-1 flex flex-col justify-between ${isDetail ? 'bg-white' : 'bg-mya-100'}`}>
            ...
            <CardBody className="flex-0 justify-end items-end">
                <div className='flex flex-col w-full py-2'>
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-default-500 text-xs font-normal">{'Dilihat 27 orang'}</span>
                    </div>
            ...
            <CardFooter className="flex justify-between items-center px-4">
                ...
                <Button className="bg-mya-600 text-mya-100 font-semibold rounded-xl" onClick={() => router.push(`/mya/product/${product.productId}`)}>
                    + Keranjang
