...
const ProductCard: React.FC<ProductCardProps> = (
    { category, name, views, description, image, price }
) => {
    // Implement your component logic here

    return (
        <Card className="w-full bg-mya-100 rounded-2xl shadow-md p-1 flex flex-col justify-between">
            <CardHeader className="pb-0 pt-2 px-4 flex-col flex-1 h-full items-start flex-grow">
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <p className="text-sm font-normal font-openSans text-default-700 leading-tight mt-4">{description}</p>
                </div>
            </CardHeader>
            ...
            <CardFooter className="flex justify-between items-center px-4">
                <span className="text-default-700 text-xl md:text-sm xl:text-xl font-normal font-openSans">{price}</span>
