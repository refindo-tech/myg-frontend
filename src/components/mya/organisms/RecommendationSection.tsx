            ...
            <div className="flex flex-col md:flex-row gap-8 h-full">
                <Card shadow="none" className='flex-1 flex md:basis-3/5'>
                    ...
                    <CardFooter className="pb-0 pt-2 px-4 flex-col items-start">
                        {/* <h4 className='text-black text-2xl font-medium font-playfair leading-8 py-2'>{firstProduct.name}</h4> */}
                        <Link
                        ...
                        <div className="text-sm font-normal font-openSans text-default-700 leading-normal">{cutDescription(firstProduct.description, length = 300)}</div>
                        <span className="text-black text-xl md:text-sm xl:text-xl font-normal font-openSans py-2">{rupiah(firstProduct.priceId)}</span>
                    </CardFooter>
                </Card>
                    ...
                    {recommendedProducts.slice(1).map((product, index) => (
                        <Card key={index} shadow="none">
                            ...
                            <CardFooter className="pb-0 pt-2 px-4 flex-col items-start flex-grow">
                                ...
                                <div className="text-sm font-normal font-openSans text-default-700 leading-normal">{cutDescription(product.description, length = 200)}</div>
                                <span className="text-black text-xl md:text-sm xl:text-xl font-normal font-openSans py-2">{rupiah(product.priceId)}</span>
                            </CardFooter>
                        </Card>
                    ))}
                </div>
