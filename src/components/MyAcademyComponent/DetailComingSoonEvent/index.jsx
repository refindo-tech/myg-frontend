...
const DetailComingSoonEvent = () => {
    const { CloudIcon, CollectionIcon } = icons
    return (
        <>
            <NavbarMyAcademy color={'white'} />
            <div className="absolute top-[60px] left-0 h-[60vh] lg:h-screen flex items-center justify-center bg-[url('/images/bg-detailcomingsoon.png')] backdrop-contrast-0 bg-cover bg-center bg-no-repeat w-full px-[5%] lg:pt-0">
                <div className="grid grid-cols-1 lg:grid-cols-2 container gap-y-3 mt-[80px]">
                    <div className="flex flex-col lg:gap-12 gap-3 max-w-[580px] sm:min-h-[30vh]">
                        <h3 className="font-playfair text-white text-xl lg:text-5xl font-medium">Workshop Kecantikan Alami</h3>
                        <p className="font-sans font-normal lg:text-lg sm:text-xs text-white">
                    ...
                    <div className="rounded-xl bg-white w-full lg:w-[60%] py-[30px] gap-6 shadow-2xl lg:shadow-none mx-auto">
                        <div className="w-[90%] mx-auto flex flex-col gap-3">
                            ...
                            <p className="font-sans font-normal text-xs lg:text-lg">
                                Saturday, July 14, 2024 at 10:00 WIB
                            </p>
                            <div className="flex flex-col gap-3">
                                ...
                                <button className="flex flex-row items-center h-12 rounded-lg bg-active justify-center text-white">
                    ...
                    <div className="w-[90%] mx-auto flex flex-col gap-y-6">
                        <div className="flex flex-col gap-y-3">
                            ...
                            <p className="font-sans text-xs lg:text-xl font-normal text-abumuda text-wrap">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa necessitatibus eveniet unde ad consectetur provident cupiditate veniam fugiat iusto ut corrupti quae velit laborum totam odio, incidunt temporibus fuga minus!
                            </p>
                        </div>
                        <div className="flex flex-col gap-y-3">
                        ...
                        <div className="flex flex-col gap-y-3">
                            ...
                            <div>
                                <p className="font-sans text-xs lg:text-xl font-normal text-abumuda text-wrap">
                                    Tanggal: <span className="font-sans text-xs lg:text-xl font-bold text-abumuda text-wrap">15 Juli 2024</span>
                                </p>
                                <p className="font-sans text-xs lg:text-xl font-normal text-abumuda text-wrap">
                                    Waktu: <span className="font-sans text-xs lg:text-xl font-bold text-abumuda text-wrap">10:00 - 12:00 WIB</span>
                                </p>
                                <p className="font-sans text-xs lg:text-xl font-normal text-abumuda text-wrap">
                        ...
                        <div className="flex flex-col gap-y-3">
                            ...
                            <div className="pl-6">
                                <ol className="list-decimal font-sans text-xs lg:text-xl font-normal text-abumuda text-wrap">
                                    ...
                                    <li>Pilih sesi &apos;Workshop Kecantikan Alami&apos;. </li>
                    ...
                    <div className="w-[90%] flex flex-col mx-auto gap-y-6">
                        ...
                        <div className="flex flex-col gap-y-3 lg:gap-y-7">
                            ...
                            <p className="text-wrap font-sans text-xs lg:text-xl font-normal text-abumuda">
                                RT.13/RW.6, Kb. Kosong, Kec. Kemayoran, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10630
                            </p>
                        </div>
                    </div>
                </div>
                <div className="bg-birumuda">
                    <ComingSoonEvent bgcard={'bg-white'} title={'Daftar Acara Lainnya'} />
                </div>
                <Review />
                <FAQAcademy />
                <FooterMyAcademy />
