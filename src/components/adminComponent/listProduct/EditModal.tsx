        ...
        <Modal isOpen={isOpen} onClose={onClose} placement="top-center">
            <ModalContent>
                <ModalHeader className="flex flex-col items-center border-b pb-4">
                    ...
                    <p className="text-sm text-gray-500">Ubah data produk berikut</p>
                </ModalHeader>
                            ...
                            {product.imageUrl ? (
                                <div className="flex flex-col items-center">
                                    ...
                                    <p className="text-sm text-gray-500">
                                        {typeof product.imageUrl === "string" ? "Image uploaded" : "Change image"}
                                    </p>
                                </div>
                            ) : (
                                <>
                ...
                <ModalFooter>
                    <Button fullWidth variant="light" onPress={onSave} className="bg-kuning2 text-white font-bold">
                        Simpan Perubahan
                    </Button>
                </ModalFooter>
            </ModalContent>
