          ...
          <div className="flex items-center justify-center pb-6 border-b-medium">
            <div className="flex items-center w-full justify-center space-x-4">
              ...
              <div className="w-[150px] mx-4">
                <Progress value={50} classNames={{indicator: "bg-kuning2"}}/>
              </div>
              <div className="flex items-center justify-center w-[26px] h-[26px] rounded-full bg-gray-200 text-10px text-black">2</div>
            </div>
          </div>
