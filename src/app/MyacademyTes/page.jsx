...
import {getListMaterial, getRecommendationTraining} from "@/helpers/fetchAPI"
    ...
    return (
        <>
            ...
            <div className="min-h-[50vh] lg:min-h-screen grid sm:grid-cols-1 lg:grid-cols-2 w-full bg-[url('/images/bghomemyacademy.png')] bg-no-repeat lg:bg-cover md:bg-left lg:bg-center">
                <div className="flex flex-wrap h-full items-center text-wrap bg-gradient-to-b lg:bg-gradient-to-r from-birumuda via-birumuda to-transparent pt-[92px]">
                    <div className="w-[90%] md:w-[60%] mx-auto flex flex-col gap-3 lg:gap-12 pt-9">
                        ...
                        <Link href={'#'} className="h-4 lg:h-12 bg-primary-500 lg:bg-active text-white flex items-center justify-center lg:px-3 font-semibold rounded-lg w-20 lg:w-36 text-[8px] lg:text-sm">Lihat acara kami</Link>
                    </div>
